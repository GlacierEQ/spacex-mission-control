"""
Mastermind Sidecar — spacex-mission-control
...
class MastermindSidecar:
    ...
    def __init__(self, repo_name: str = "spacex-mission-control"):
        self.repo_name = repo_name
        self.start_time = time.time()
        self.health_cache: Dict[str, Any] = {}
        self._modules = [telemetry_aggregator, cross_domain_fusion, mission_orchestrator]
